...
Public Class frm07consultasLibrosPais
    Private Sub frm07consultasLibrosPais_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LlenarComboPais()
    End Sub
    ...
    Private Sub ExportarLibrosPaisCSV()
        Try
            Dim AD As New StreamWriter("ListadoLibrosPais.CSV", False, Encoding.UTF8)
            AD.WriteLine("Listado de libros de: " + cmbPais.Text)
            AD.WriteLine("")
    ...
    Private Sub DocumentoImprimir_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles DocumentoImprimir.PrintPage
        Try
            ...
            e.Graphics.DrawString("Listado de libros de " & cmbPais.Text, TipoTitulo1, Brushes.Black, 180, fila)
            fila = fila + 60
